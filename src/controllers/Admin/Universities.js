...
function AddUniversity(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var result, data, unversity, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, university_1.AddUniversitySchema.safeParseAsync(req.body)];
                case 1:
                    result = _a.sent();
                    if (!result.success) {
                    ...
                    data = result.data;
                    return [4 /*yield*/, prisma_1.prisma.university.create({
                            data: {
                                name: data.name,
