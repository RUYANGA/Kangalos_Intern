...
//   nameCollege:       z.string().min(3, "College name is required"),
//   locationCollege:   z.string().min(2, "College location is required"),
//   descriptionCollege:z.string().min(3, "College description is required"),
  
//   nameDir:           z.string().min(2, "Director name is required"),
//   email:             z.string().email("Valid email is required"),
//   gender:            z.enum(["Male", "Female"]),
//   password:          z.string().min(5, "Password must be at least 6 characters"),
//   phone:             z.string().optional() // if not in your model, remove this
// });

// export type AddCollegeBody = z.infer<typeof AddCollegeSchema>;
