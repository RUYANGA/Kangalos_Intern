...
import {Register,resendOtp,verifyOtp,Login} from '../../controllers/user'
import {RegisterValidation,resendOtpValidation,verifyOtpValidation,LoginValidation} from '../../middlewares/RequestValidations/requestValidator'
